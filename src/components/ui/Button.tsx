...
export function Button({
    ...
    const variants = {
        primary: "bg-slate-900 dark:bg-white text-white dark:text-black hover:opacity-90 shadow-lg shadow-slate-900/20 dark:shadow-white/20",
        ...
        ghost: "bg-transparent text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-white/5",
    };
